...
from PySide6.QtWidgets import (
    QApplication, QDialog, QSizePolicy, QStyle, QVBoxLayout, QHBoxLayout, QFormLayout,
...
from PySide6.QtGui import QIcon, QPalette, QScreen, QColor, QPixmap, QMovie, QGuiApplication, QImageReader
...
class ManageSharesDialog(QDialog):
    ...
    def handle_revoke_share(self):
        ...
        if reply == QMessageBox.Yes:
            ...
            # 在 share.py 中，我们将 revoke_share 重命名为了 revoke
...
class CreateShareDialog(QDialog):
    ...
    def get_data(self):
        ...
        return {
            ...
            "config_data": final_config_data # 使用我们净化过的数据
        }
